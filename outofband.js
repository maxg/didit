...
exports.notify = function(spec, buildId, recipients, options) {
  log.info({ spec: spec, recipients: recipients, options: options }, 'notify', buildId);
  ...
  async.auto({
    ...
    mailer.sendMail(recipients, subject, 'build', {
      spec: spec,
      url: options.url,
      build: results.build,
